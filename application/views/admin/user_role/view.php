								...
								<div class="col-md-6 justify-content-md-end d-flex">
									<div class="breadcrumb_nav">
										<ol class="breadcrumb">
											...
											<li>
												<i class="fa fa-home"></i>
												<a class="parent-item" href="<?php echo base_url('admin/user_role')?>">User Roles</a>
												<i class="fa fa-angle-right"></i>
											</li>
											<li class="active">
												View
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="role_name" class="col-sm-4 text-right control-label col-form-label">Role Name : </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                    <a href="<?php echo base_url('admin/user_role')?>" type="button" class="btn btn-success btn-sm">Back</a>
									<a href="<?php echo base_url('admin/user_role/'.$role_id)?>" type="button" class="btn btn-primary btn-sm">Edit</a>
                                    </div>
                                </div>
